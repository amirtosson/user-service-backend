...
--
-- Table structure for table `datasets_list`
--

DROP TABLE IF EXISTS `datasets_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `datasets_list` (
...
--
-- Dumping data for table `datasets_list`
--

LOCK TABLES `datasets_list` WRITE;
/*!40000 ALTER TABLE `datasets_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `datasets_list` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-12-11 18:06:03
