...
function GetDatasetsByUserId(req,res) {
    ...
    " INNER JOIN methods_list ON datasets_list.data_facility_id = facilities_list.facility_id" +
    " INNER JOIN methods_list ON datasets_list.data_exp_system_id = exp_systems_list.exp_system_id" +
